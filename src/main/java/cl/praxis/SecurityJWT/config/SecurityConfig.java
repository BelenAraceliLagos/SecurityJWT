package cl.praxis.SecurityJWT.config;

import cl.praxis.SecurityJWT.config.filter.JwtTokenValidator;
...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurirty) throws Exception {
        return httpSecurirty
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    //http.requestMatchers(HttpMethod.POST, "/auth/patch").hasRole("ADMIN");
